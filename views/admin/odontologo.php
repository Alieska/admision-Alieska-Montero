...
<div style="width: 90%; margin: 100px auto; border: 1px solid #666; border-radius: 10px; background-color: #fff; padding: 15px;">
  ...
  <h4 class="ui dividing header">Odontólogos</h4>
  ...
  <tbody>  
    ...
    <?php foreach($cedulas as $cedula): ?> 
     ...
     <tr>
      ...
      <td style="color: #212F3D;" ><?php echo $cedula['celular']; ?></td>
      <td style="color: #212F3D;" ><?php echo $cedula['genero']; ?></td>
      <td style="color: #212F3D;" ><?php echo $cedula['especialidad']; ?></td>

      <td><span onclick="eliminarHistoria(id)" id="eli-<?=$cedula['cedula'];?>"><i class="fas fa-times" style="color: #FF0000; cursor: pointer;" title="Eliminar Odontologo"></td> 

      <td>

        <a href="modificarOdontologo?ci=<?=$cedula['cedula'];?>">

        <i class="fas fa-edit" style="color: #0174DF; cursor: pointer;" title="Modificar Odontologo">
