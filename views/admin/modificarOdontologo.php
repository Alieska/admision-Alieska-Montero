...
if(isset($_GET['ci']) && !empty($_GET['ci'])) {
  ...
  $mostrarOdontologo = new Admin_Actions();
  ...
  $odontologo =  $mostrarOdontologo->selectForId("odontologo", $arrayTodo, $condicion);
...
<div class="twenty wide field">
   <div class="two fields">
        ...
        <div class="field">
          <label>Nombre</label>
          <input type="text" class="textNombre" maxlength="20" value="<?=$odontologo[0]['nombre'];?>">
        </div>

         <div class="field">
          <label>Apellido</label>
          <input type="text" class="textApellido" maxlength="20" value="<?=$odontologo[0]['apellido'];?>">
        </div>
...
<div class="two fields">
  ...
  <div class="field">
       <label>Cédula</label>
       <input type="text" class="textCedula" maxlength="8" placeholder="12345678" value="<?=$odontologo[0]['cedula'];?>" >
  </div>

  <div class="field">
      <label>Celular</label>
      <input type="text" class="textCelular" maxlength="11" placeholder="12345678900" value="<?=$odontologo[0]['celular'];?>" >
  </div>
...
<div class="field">
      <label>Género</label>
      <input type="hidden" id="genero-hidden" value="<?=$odontologo[0]['genero'];?>">
  ...
  <label>Especialidad</label>
    <div class="twenty wide field">
      <input type="hidden" id="especialidad-hidden" value="<?=$odontologo[0]['especialidad'];?>">
      <select id="especialidad-edit" class="ui fluid search dropdown" name="especialidad">
            <option value="0" disabled="true" selected="true">Seleccione</option>
...
<div style="text-align: center;">
  <button class="ui basic blue button btnGuardarOdontologo" >Guardar</button>
</div>
