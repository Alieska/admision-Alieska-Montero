...
<div class="twenty wide field">
   <div class="two fields">
    ...
    <div class="field">
      <label>Hora</label>
          <input type="text" class="textHora" maxlength="5" placeholder="Hora">
    </div>

<div class="field">
  <label>Turno</label>
      <select class="ui fluid search dropdown" name="turno">
  ...
  <label>Odontólogo</label>
    <div class="twenty wide field">
      ...
      <select class="ui fluid search dropdown" name="odontologo">
        ...
        <?php foreach($cedulas as $cedula): ?>
            ...
            <?php echo $cedula['apellido']; ?>"><?php echo $cedula['nombre']; ?>
...
<div style="text-align: center;">
  <button class="ui basic blue button btnAgregarCita" >Agregar</button>
</div>
